	...
	/* public void infoCamera(){
		if (GameObject.FindWithTag ("Dialog_error_PLCSIM") == null && GameObject.FindWithTag ("Dialog_camera_info") == null) {
			Dialog.MessageBox (
				...
				"Drag objects (blue cylinders) with a left mouse button. "+
				"Right click removes an object.\n\n"+
				"Hold SHIFT and use your mouse buttons to control the camera:\n" +
				"    left - rotation,\n" +
				...
				"    D - bottom-right,\n" +
				"    A - green.\n\n" +
				"Credits: Nejc Ilc, Klemen Gantar, Matevž Kren\n"+ 
