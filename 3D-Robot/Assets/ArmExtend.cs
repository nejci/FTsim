// Script for controlling the horizontal axis of the robot - i.e., the extension of the robot's arm.
// 
...
public class ArmExtend : MonoBehaviour {
	...
	public Transform arm_position; // object that defines position and is used to trigger pulses
